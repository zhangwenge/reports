...
import cn.com.dplus.report.entity.others.DevEnvFactor;
...
public class SpecimenRecord extends BaseEntity implements Comparable<SpecimenRecord>{
	...
	public List<String> getDevStateIds() {
		return devStateIds;
	}

	public void setDevStateIds(List<String> devStateIds) {
		this.devStateIds = devStateIds;
	}
